...
![Remote_vs_Local_MCP_server](images/git_remote_local_mcpservers.png)
...
```
Issue → Agent → Code Changes → Tests → Pull Request → Review
```
...
![MCP_vs_agent](images/git_mcp_vs_agent.png)
